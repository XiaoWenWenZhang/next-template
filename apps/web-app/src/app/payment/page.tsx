...
import { Checkbox, Form, Label } from "@faststore/ui";
      ...
      <div style={{ display: "flex", height: "100vh" }}>
        ...
        <div
          style={{
            ...
            borderLeft: "2px sold rgba(223,231,234,.4)",
            boxShadow: "15px 0 30px 0 rgba(0,0,0,.18)",
          }}
        >
          <div style={{ paddingBottom: "15px", fontWeight: 600, borderBottom: "2px solid #dfe7ea", width: "100%" }}>
            Pay With Card
          </div>
          <Form>
            ...
            <div>
              <Label>
                <Checkbox required />I agree to receive emails from Brand. View our <a href="/">Privacy Policy</a>.
              </Label>
            </div>
          </Form>
          <Link href="/">
